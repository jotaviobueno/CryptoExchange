...
import UserController from '../http/controller/client/ClientController';
...
router.post('/api/v1/my-account/:session_token/change-name', ChangeController.changeName);
...
router.get('/api/v1/:session_token/get-token/', GetTokenController.tokenToChangeTheEmail);